...
const n=e.regex,t="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",a={
  ...
  /* The below Code was modified by: https://github.com/mahdiware. */
keyword:"if elif else class import fn function do end from as in is and or not this super break while for continue return then",
built_in:"print input _name _init",literal:"true false null __file__"},
