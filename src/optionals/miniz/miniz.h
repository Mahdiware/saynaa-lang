...
static MZ_FORCEINLINE int deflateInit2(mz_streamp pStream, int level, int method,
                                       int window_bits, int mem_level, int strategy) {
...
MINIZ_EXPORT void* tdefl_write_image_to_png_file_in_memory(const void* pImage, int w,
                                                           int h, int num_chans,
                                                           size_t* pLen_out);
...
MINIZ_EXPORT mz_bool mz_zip_reader_init_mem(mz_zip_archive* pZip, const void* pMem,
