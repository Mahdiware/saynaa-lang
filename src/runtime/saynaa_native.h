...
NativeApi MakeNativeAPI() {
  ...
  api.ClearImportResolveCache_ptr = ClearImportResolveCache;
  ...
  api.RunFileAutoDetect_ptr = RunFileAutoDetect;
  api.LoadScriptAutoDetect_ptr = LoadScriptAutoDetect;
