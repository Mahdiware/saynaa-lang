...
// Payload format magic and version. Bump when the payload layout changes.
#define SAYNAA_BYTECODE_PAYLOAD_MAGIC "SAYNAA"
#define SAYNAA_BYTECODE_PAYLOAD_MAGIC_SIZE 6
