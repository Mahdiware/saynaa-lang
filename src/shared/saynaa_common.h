...
#ifndef __SAYNAA_COMMON__
#define __SAYNAA_COMMON__
...
// just above the function by the function() macro below.
...
#define function(fn, signature, docstring)                        \
  static const char* DOCSTRING(fn) = signature "\n\n" docstring;  \
  static void fn(VM* vm)

#endif //__SAYNAA_COMMON__