...
// Use __ASSERT() to ensure the application terminates even in release builds.
#define TODO __ASSERT(false, "TODO: Feature not yet implemented.")
#define OOPS "Internal Error: Please report this bug."

// Returns the docstring of the function, which is a static const char* defined
// just above the function by the saynaa_function() macro below.
#define DOCSTRING(fn) __doc_##fn

// A macro to declare a function, with docstring, which is defined as
// __doc_<fn> = docstring; That'll used to generate function help text.
// [signature] is the function name and parameter names with type information.
// ex: `io.open(path:String, mode:String) -> io.File`
#define saynaa_function(fn, signature, docstring) \
